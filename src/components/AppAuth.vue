  ...
  methods: {
    ...
    validateEmailRegister(e){
       ...
       if (e.target.value == null || e.target.value == '') {
        ...
        this.inputValidation.email.message = "You got it right do not worry we won't spam you "
      }
...
<template>
  <!--Auth Login & Register-->
  <div
    class="absolute opacity-75 bg-black w-full h-full top-100 bottom-0"
    v-show="isHidden === true"
  >
    <div
      class="bg-white rounded ml-auto mr-auto w-4/5 h-fit pb-6 "
      :class="{
        'h-4/6  mt-32': tab === 'Login',
    ...
    >
     <div class="w-full ml-[95%] pt-[1%]">
      ...
      <div class="w-full h-fit text-center pt-3">
        <!--Login-->
          ...
          <div>
            ...
            <vee-field name="email"
              ...
              <input
                ...
                :class="{'border-green-500 outline-green-500':isValid === true,
                         'border-red-500 outline-red-500': isValid === false}"
                type="email"
       ...
       <vee-form v-show="tab === 'Register'" :validation-schema='schemaRegister'>
          ...
          <div class=" mb-1">
            ...
            <vee-field v-slot="{field,errors}" name="name">
              ...
              class="border outline-input-color  border-2 w-5/6 h-9 pl-5 rounded border-input-color"
              :class="{'border-green-500 outline-green-500':inputValidation.name.isValid === true,
                      'border-red-500 outline-red-500': inputValidation.name.isValid === false}"
              type="text"
              placeholder="Enter your name"
            />
            <div class="mt-2 text-start ml-[8.2%]"
          ...
          <div class="">
              ...
              <vee-field v-slot="{field,errors}" name="email">
                ...
                class="border outline-input-color  border-2 w-5/6 h-9 pl-5 rounded border-input-color"
                :class="{'border-green-500 outline-green-500':inputValidation.email.isValid === true,
                        'border-red-500 outline-red-500': inputValidation.email.isValid === false}"
                type="email"
              ...
              <div class="mt-3 text-start ml-[8.2%]"
                  v-if="inputValidation.email.isValid === true">
                <span class="text-green-500">{{inputValidation.email.message}}</span>
              </div>
              </vee-field>
            </div>
              <!--Password-->
            <div class="">
              ...
              <vee-field v-slot="{field,errors}" name="password">
                ...
                name="password"
                v-bind="field"
                @focus="validatePasswordRegister($event)"
                class="border outline-input-color  border-2 w-5/6 h-9 pl-5 rounded border-input-color"
                :class="{'border-green-500 outline-green-500':inputValidation.password.isValid === true,
                        'border-red-500 outline-red-500': inputValidation.password.isValid === false}"
                type="password"
            ...
            <!--confirm Password-->
            <div class="">
              <label class="block ml-[8.2%] mb-2 mt-2 text-start">confirm password :</label>
              <vee-field v-slot="{field,errors}" name="password">
                <input
                name="password"
                v-bind="field"
