...
<template>
    <section  class="absolute bg-black w-full h-full top-0 left-0 bg-opacity-50"
         ...
         <vee-form :validation-schema = "addTaskSchema">
            ...
            <div class="ml-12 mt-6">
              ...
              <vee-field  name="title"
                          v-slot="{field,errors}">
                  <input class="w-[90%] border mt-3 border-bg-bg-color rounded pl-3 h-[40px]"
                         name="title"
                         v-bind='field'
                         type='text'
              ...
              <div class="mt-4">
              <!--Subtask-->
              <label class="ml-12 mt-6 font-bold">
                Subtasks: 
              </label>
              </div>
              <div  class="ml-12 mt-2"
                    v-for="(Subtask,index) in Subtasks" :key="index">
                  ...
                  <vee-field v-slot="{field,errors}"
                      ...
                      <div>
                        ...
                        :name="`Subtask${index + 1}`"
                        />
                        <span class="ml-3 mb-2 text-xl cursor-pointer "
            ...
            <div class="text-center mt-6">
              <input class="w-[70%] cursor-pointer text-center text-white font-bold text-center rounded-full h-[40px] bg-main-color"
              type="submit"
              value="+ Add Task"
             />
            </div>
